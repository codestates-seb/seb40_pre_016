        ...
        <S.HeaderContainer>
            <S.Container>
                ...
                <S.IsLoginWarp className={isLogin ? null : 'none'}>
                    <Link to='/user/profile'><S.UserProfile ><img src={userImage} alt='uerimg' /> </S.UserProfile></Link>
                    <S.IconListWarp>
                        <S.Icon>
                ...
                <S.LoginBtn className={isLogin ? 'none' : null}><Link to='/login' >Log in</Link></S.LoginBtn>
                <S.SignupBtn className={isLogin ? 'none' : null}><Link to='/signup' >Sign up</Link></S.SignupBtn>
            </S.Container>
