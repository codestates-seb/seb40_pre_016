...
const Modal = () => {
  ...
  return (
    <S.ModalSelect>
      ...
      <S.ModalContainer>
        <div>
          <button className='cancel' onClick={modalHandler}>
            X
          </button>
          <h1>Asking a good question</h1>
          <p>
            You’re ready to ask your first programming-related question and the
            community is here to help! To get you the best answers, we’ve
            provided some guidance:
          </p>
          <p>
            Before you post,{' '}
            <a href='https://stackoverflow.com/search'>search the site</a> to
            make sure your question hasn’t been answered.
          </p>
          <ul>
